<?php
echo '<form id="user" action="../../pages/deals/deal.php" method="POST"> <input type="hidden" name="id" value="' . $_POST['id'] . '">
</form>';
require '../db.php';
...
$sql = "update `code` set title=?,details=?,type=?,end_date=? where id= ?";

$stmt = $conn->prepare($sql);
$stmt->execute(array($_POST['title'], $_POST['details'], $_POST['type'], $_POST['date'], $_POST['id']));
$s = $_POST['store1'];
if (isset($s) && !empty($s)) {
