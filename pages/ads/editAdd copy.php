                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-10">
                                                        <input type="date" class="form-control" name="start" value="<?php echo $result[0][2];?>"  required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="example-search-input2" class="col-2">تاريخ إنتهاء</label>
                                                    <div class="col-10">
                                                        <input type="date" class="form-control"  name="end" value="<?php echo $result[0][3];?>"  required>
                                                    </div>
                                                </div>
                                            </div>

                                        </div>
                                        <form id="delete<?php echo$result[$i]['id']; ?>" action="../../api/adds/deletead.php" method="POST"> <input type="hidden" name="id" value="<?php echo$result[$i]['id']; ?>"><a onclick="delete_add(<?php echo$result[$i]['id']; ?>);"><button type="button" class="btn btn-danger btn-fw">مسح</button></a></form>
