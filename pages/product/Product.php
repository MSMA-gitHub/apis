                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-10">
                                                    <input type="text" name="name" class="form-control"
                                                           value="<?php echo $result[0]['name']; ?>" id="" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-10">
                                                    <textarea class="form-control" name="details" rows="5" id="comment"
                                                              required><?php echo $result[0]['details']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row" id="old">
                                                ...
                                                <div class="col-10">
                                                    ...
                                                    for ($i = 0; $i < $branch_size; $i++) {
                                                        echo ' <div id="branch' . $branch[$i]['0'] . '" class="btn btn-dark btn-rounded btn-sm" 
                                                            onclick="delete_branch(' . $branch[$i]['0'] . ');">
                                                            ' . $branch[$i][1] . '<i class="mdi mdi-close-circle-outline"></i></div>';
                                                    }
                                                    ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-10">
                                                    <input type="number" name="price" class="form-control"
                                                           value="<?php echo $result[0]['price']; ?>" id="" required>
                                                </div>
                                            </div>
                                        </div>
    ...
    function delete_branch(x) {
        ...
        $.ajax({
            ...
            success: function (data) {
                setTimeout(function () {
                   alert(data);
                   if(data=='لا يمكن حذف اخر فرع احذف المنتج او اضف فرع اخر اولا')
