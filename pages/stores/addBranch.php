                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-4">
                                                    <div class="col-10">
                                                        <input type="time" name="sat_o" class="form-control" .>
                                                    </div>
                                                </div>
                                                <label for="example-search-input2" class="col-2">السبت إلي :</label>
                                                <div class="col-4">
                                                    <input type="time" name="sat_c" class="form-control" .>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-4">
                                                    <div class="col-10">
                                                        <input type="time" name="sun_o" class="form-control" .>
                                                    </div>
                                                </div>
                                                <label for="example-search-input2" class="col-2">الأحد إلي :</label>
                                                <div class="col-4">
                                                    <input type="time" name="sun_c" class="form-control" .>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-4">
                                                    <div class="col-10">
                                                        <input type="time" name="mon_o" class="form-control" .>
                                                    </div>
                                                </div>
                                                <label for="example-search-input2" class="col-2">الأثنين إلي :</label>
                                                <div class="col-4">
                                                    <input type="time" name="mon_c" class="form-control" .>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-4">
                                                    <div class="col-10">
                                                        <input type="time" name="tue_o" class="form-control" .>
                                                    </div>
                                                </div>
                                                <label for="example-search-input2" class="col-2">الثلاثاء إلي :</label>
                                                <div class="col-4">
                                                    <input type="time" name="tue_c" class="form-control" .>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-4">
                                                    <div class="col-10">
                                                        <input type="time" name="wen_o" class="form-control" .>
                                                    </div>
                                                </div>
                                                <label for="example-search-input2" class="col-2">الأربعاء إلي :</label>
                                                <div class="col-4">
                                                    <input type="time" name="wen_c" class="form-control" .>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-4">
                                                    <div class="col-10">
                                                        <input type="time" name="thu_o" class="form-control" .>
                                                    </div>
                                                </div>
                                                <label for="example-search-input2" class="col-2">الخميس إلي :</label>
                                                <div class="col-4">
                                                    <input type="time" name="thu_c" class="form-control" .>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-4">
                                                    <div class="col-10">
                                                        <input type="time" name="fri_o" class="form-control" .>
                                                    </div>
                                                </div>
                                                <label for="example-search-input2" class="col-2">الجمعة إلي :</label>
                                                <div class="col-4">
                                                    <input type="time" name="fri_c" class="form-control" .>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-4">
                                                    <div class="col-10">
                                                        <input type="number" name="lan" class="form-control" .
                                                               required>
                                                    </div>
                                                </div>
