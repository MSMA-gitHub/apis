                                    ...
                                    <div class="form-group row">
                                        <div class="col-2">
                                            <div onclick="pro1()" class="nav-profile-image">
                                                ...
                                                <img src="../../api/<?php echo $result[0][3]; ?>" style="max-width:100%"
                                                     id="img">
                                                <h5>ارفع صورة</h5>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-10">
                                                    <input type="text" name="name" class="form-control"
                                                           value="<?php echo $result[0][0]; ?>" id="" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-2 col-form-label">نوع
                                                    الفئة</label>
                                                <div class="col-10"><select id="type" name="type" class="form-control"
                                                                            onchange="cat()" required>
                                                        <?php
                                                        if ($result[0][2] == 0)
