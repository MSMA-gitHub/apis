            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="rtl col-12 grid-margin">
                        <div class="card">
                            <form action="../../api/code/update.php" enctype="multipart/form-data" method="post">
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-2 col-form-label">كود
                                                    الكوبون</label>
                                                <div class="col-10">
                                                    <input type="text" name="code" class="form-control" value="<?php
                                                    echo $code[0]['code']; ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
